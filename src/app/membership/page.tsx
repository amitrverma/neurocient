    ...
    <main className="px-6 py-20 bg-white font-serif">
      <div className="max-w-3xl mx-auto space-y-20">
        ...
        <section className="text-center space-y-6">
          ...
          <p className="text-lg md:text-xl text-brand-dark/70 leading-relaxed max-w-2xl mx-auto">
        ...
        <section className="space-y-10">
          ...
          <div className="space-y-4">
            ...
            <ul className="list-disc list-inside text-brand-dark space-y-1 text-base">
        ...
        <section className="space-y-8">
          ...
          <div className="space-y-6">
            <blockquote className="italic text-lg text-brand-dark text-center max-w-2xl mx-auto">
        ...
        <section className="space-y-6">
          ...
          <div className="space-y-4 text-brand-dark text-base max-w-2xl mx-auto">
