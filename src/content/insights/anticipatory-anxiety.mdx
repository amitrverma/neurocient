...
<div className="prologue-line-stack">
  A meeting scheduled tomorrow.<br />
  A message that hasn't been answered.<br />
  A medical test result still pending.<br />
...
<div className="prologue-line-stack">
  What if it goes badly?<br />
  What if something is wrong?<br />
...
<div className="prologue-line-stack">
  Emails waiting for response.<br />
  Economic volatility.<br />
  Health alerts and medical tests.<br />
  Ambiguous social signals.<br />
...
<div className="prologue-line-stack">
  Reputational risk instead of physical exile.<br />
  Financial abstraction instead of immediate scarcity.<br />
  Delayed communication instead of immediate signals.<br />
...
<div className="prologue-line-stack">
  Why am I worrying so much?<br />
  Why can't I relax?<br />
